...
public class PremierLeagueDAO {
	...
	public List<Adiacenza> getArchi(int min, int mese,  Map<Integer,Match> idMap){
		...
		String sql="SELECT a1.MatchID AS id1, a2.MatchID AS id2, COUNT(DISTINCT a1.PlayerID) AS peso "
				...
				+ "WHERE a1.MatchID < a2.MatchID AND a1.TimePlayed>=? AND a1.PlayerID=a2.PlayerID  "
				+ "      AND a2.TimePlayed>=? "
				+ "      AND  MONTH(m1.Date)=? AND m1.MatchID= a1.MatchID "
				+ "      AND   MONTH(m1.Date) =  MONTH(m2.Date) AND m2.MatchID = a2.MatchID "
